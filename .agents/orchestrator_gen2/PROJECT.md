...
|---|------|-------|-------------|--------|
| M1 | Core Framework, Database & Router | Features 1-8: PSR-4 Autoloader, PDO DB singleton, schema.sql, migration runner, router.php (port 8015 on 0.0.0.0), CSRF, base layout | none | DONE |
| M2 | Public Portal, Educational Hub & SEO | Features 9-17: Home, Courses, Books, Blog (Bengali slugs), Pages, Schema.org JSON-LD, XML sitemap | M1 | IN_PROGRESS |
